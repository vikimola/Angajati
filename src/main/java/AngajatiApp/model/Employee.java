...
public class Employee {
    /** * adauga un angajat in repository * @param employee - un angajat cu atributele
     * id, lastName, firstName, cnp, function, salary * @return boolean - false daca
     * employee nu este valid */
